...
export default function RaceCard({
  ...
  return (
    <div className="relative flex rounded-2xl overflow-hidden bg-[hsl(var(--card))] shadow-xl hover:shadow-2xl transition-all duration-300 group">
      {/* Sidorna */}
      ...
      <div className="bg-[hsl(var(--hero-background))] px-4 py-6 flex flex-col items-center justify-center w-28 shrink-0 text-[hsl(var(--card))] text-center">
        ...
        <span className="text-xl font-bold text-white/90">{day}</span>
        ...
        <div className="pl-4 pr-6 py-4 flex flex-col justify-center items-start shrink-0 min-w-[150px]">
          ...
          <div className="flex items-center gap-2">
            <p className="text-2xl font-bold text-[hsl(var(--primary))]">
              {priceTicketOnly.toLocaleString('sv-SE')} kr
            </p>
